/*
 * This class handles DELETE Restful operation via DELETE HTTP method
...
public class RestfulDeleteTask extends AsyncTask<String, Void, String> {
    ...
    private TextView cardNameView, cardNumberView;
    private String cardName, cardNumber;

    /**
     * Initialising the constructor
     */
    public RestfulDeleteTask(TextView cardNameView, TextView cardNumberView, String cardName, String cardNumber) {
